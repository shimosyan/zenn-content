...
```sh
powershell -ExecutionPolicy Bypass ".\msiInstaller.ps1 'Label' 'Path' 'URL'"
```
...
|アプリケーション|コマンド例|
|---|---|
|Google Chrome (64bit)|`powershell -ExecutionPolicy Bypass ".\msiInstaller.ps1 'Google Chrome' 'C:\Program Files\Google\Chrome\Application\chrome.exe' 'https://dl.google.com/dl/chrome/install/googlechromestandaloneenterprise64.msi'"`|
